...
function DailyProductCreate(props) {
          ...
          <div className="row">
            <div className="col-12 col-md-12 col-lg-12">
              ...
              <input
                ...
                defaultValue={products[index].code}
              />
            </div>
            <div className="col-12 col-md-12 col-lg-12">
              ...
              <input
                ...
                name="name"
                className="form-control form-control-sm"
                defaultValue={products[index].name}
              />
            </div>
            ...
            <div className="col-6 col-md-6 col-lg-6">
              ...
              <input
                ...
                min="0"
                className="form-control form-control-sm"
                defaultValue={products[index].cost}
              />
            </div>
            <div className="col-4 col-md-4 col-lg-4">
              ...
              <input
                ...
                min="0"
                className="form-control form-control-sm"
                defaultValue={products[index].stock_quantity}
              />
            </div>
            <div className="col-4 col-md-4 col-lg-4">
              ...
              <input
                ...
                min="0"
                className="form-control form-control-sm"
                defaultValue={products[index].limit}
              />
            </div>
            <div className="col-4 col-md-4 col-lg-4">
...
export default DailyProductCreate
